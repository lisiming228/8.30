...
//        $imgurl=$_POST["imgurl"];
        ...
        if($db->affected_rows>0){
            echo "<script>alert('插入成功');location.href='/phpStudyTest/mvc2/index.php/admin/content/add'</script>";
        }else{
            echo "<script>alert('插入失败');location.href='/phpStudyTest/mvc2/index.php/admin/content/add'</script>";
        }
    }
    function showList(){
//        echo "查看内容";
...
//        $imgurl=$_POST["imgurl"];
        ...
        if($db->affected_rows>0){
            echo "<script>alert('修改成功');location.href='/phpStudyTest/mvc2/index.php/admin/content/edit?conid={$conid}'</script>";
        }else{
            echo "<script>alert('修改失败');location.href='/phpStudyTest/mvc2/index.php/admin/content/edit?conid={$conid}'</script>";
        }
    }
    function uploadfile(){
        $upload=new upload();
        $upload->up();
        $path=HOST_ADD."/phpStudyTest/mvc2/".$upload->fullpath;
        echo "$path";
    }
